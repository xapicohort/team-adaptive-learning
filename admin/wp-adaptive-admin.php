...
{  
    ...
    ************************************/
    ...
    add_settings_section(
        'lrs_section_id', // ID
        'LRS', // Title
        'print_lrs_section_info', // Callback
    ...
    ************************************/
    ...
    add_settings_section(
        'aws_section_id', // ID
        'AWS', // Title
        'print_aws_section_info', // Callback
        'wp-adaptive-setting-admin' // Page
    );             
...
function print_lrs_section_info()
{
    print 'Enter your LRS credentials below:';
}

function print_aws_section_info()
{
...
function text_callback($args){
    printf(
        ...
        isset( $options[$args['id']] ) ? esc_attr( $options[$args['id']]) : ''
    );
}
